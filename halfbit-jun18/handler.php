...
$course = urldecode($end_array['course']);

// mail('prekshasingla@gmail.com', $name, $email, $college, $phone);
...
$sql = "Insert into studentdetails values('".$email."','".$name."','".$college."','".$phone."','".$course."');";
// echo $sql;
